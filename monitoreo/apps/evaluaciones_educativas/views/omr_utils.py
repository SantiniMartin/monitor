...
MARK_THRESH  = 0.07          # Densidad mínima de px oscuros para "marcado"
CONF_LOW     = 40            # Confianza < 40 → ítem "dudoso"

HEADER_RATIO = 0.22          # Fracción del alto de celda ocupado por la cabecera (n° ítem)
CHECK_X_START = 0.12         # Zona del casillero: empieza en 12% del ancho de celda
CHECK_X_END   = 0.80         # Termina en 80%
CHECK_Y_MARGIN = 0.05        # Margen vertical dentro de la fila de opción
