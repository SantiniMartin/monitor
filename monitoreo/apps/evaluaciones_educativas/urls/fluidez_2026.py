...
urlpatterns = [
    ...
    path('carga_alumno/',fluidez_2026.carga_alumno, name= 'carga_alumno'),
    # path('editar_alumno/<uuid:alumno_public_id>/',fluidez_2026.editar_alumno, name= 'editar_alumno'),
	# path('carga_evaluacion/<uuid:alumno_public_id>/',fluidez_2026.carga_evaluacion, name= 'carga_evaluacion'),
	...
	# path('lista/<uuid:grado_public_id>/',fluidez_2026.lista, name='lista'),
    ...
    # path('borrar_registro_alumno/<uuid:alumno_public_id>/',fluidez_2026.borrar_registro_alumno, name='borrar_registro_alumno'),
